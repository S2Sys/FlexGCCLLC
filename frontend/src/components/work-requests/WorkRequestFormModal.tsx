    ...
    <Modal isOpen={isOpen} title={isEdit ? 'Edit Work Request' : 'New Work Request'} onClose={onClose}>
      <form onSubmit={handleSubmit}>
        <div className="form-grid">
          <label>
            <span className="label-title">Title <span className="required-mark">*</span></span>
            <input value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} required />
          </label>
          <label>
            <span className="label-title">Client <span className="required-mark">*</span></span>
          ...
          <label>
            <span className="label-title">Due date <span className="required-mark">*</span></span>
            <input type="date" value={form.dueDate} onChange={(e) => setForm({ ...form, dueDate: e.target.value })} required />
          </label>
        </div>
        <label style={{ marginTop: 12, display: 'grid', gap: 6 }}>
          <span className="label-title">Description <span className="required-mark">*</span></span>
